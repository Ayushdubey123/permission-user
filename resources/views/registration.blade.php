...
<div class="container">
    ...
    <form class="form-horizontal" action="{{route('user.store')}}" method="POST" role="form">
        ...
        <div class="form-group">
            ...
            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="view_user" value="view_user">
            <label class="form-check-label" for="inlineCheckbox1">View</label>
            <div>
            <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="create_user" value="create_user">
            <label class="form-check-label" for="inlineCheckbox1">Add</label>
            </div>
            <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="edit_user" value="edit_user">
            <label class="form-check-label" for="inlineCheckbox1">Edit</label>
            </div>
            <div class="form-check form-check-inline">
            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="delete_user" value="delete_user">
